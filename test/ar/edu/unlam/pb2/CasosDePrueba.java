...
public class CasosDePrueba {
	...
	public void queSePuedaInstanciarUnComestible() {
		...
		assertEquals("Cerealitas", ((Galletitas)producto).getDesc());
	...
	public void queSePuedaInstanciarOtroComestible() {
		...
		assertEquals("Tapa de nalga", ((Carne)producto).getDesc());
	...
	public void queSePuedaInstanciarUnElectrodomestico() {
		...
		assertEquals("Serie Dorada", ((Televisor)producto).getDesc());
	...
	public void queSePuedaInstanciarOtroElectrodomestico() {
		...
		assertEquals("Nuevo Modelo", ((Heladera)producto).getDesc());
	...
	public void queSePuedaInstanciarUnaIndumentaria() {
		...
		assertEquals("Básica", ((Remera)producto).getDesc());
	...
	public void queSePuedaInstanciarOtraIndumentaria() {
		...
		assertEquals("De running", ((Zapatilla)producto).getDesc());
...
Supermercado vital = new Supermercado("Vital");
		...
		assertEquals((Integer)4,vital.productosComestibles());
	}
